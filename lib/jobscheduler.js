...
urls.then(function(urls) {
  ...
  .then(function(options) {
    ...
    var startChild = function() {
      ...
      var c = cp.fork(__dirname + '/subjob.js', [JSON.stringify(options.pop())]);
      c.on('exit', function() {
...
var server = net.createServer(function(c) {
  c.write('status: \r\n');
  c.write('success: ' + successCount + '\tfailed: ' + failureCount + '\ttotal: ' + totalCount + '\tfinish: ' + Math.round(successCount/totalCount) + '\r\n');
